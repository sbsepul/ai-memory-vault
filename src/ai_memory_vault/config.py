...
VAULT_RAW_CLAUDE_PROJECTS_SUBDIR = "raw/claude/projects"
VAULT_RAW_CODEX_SUBDIR = "raw/codex"
VAULT_RAW_CODEX_SESSIONS_SUBDIR = "raw/codex/sessions"
VAULT_RAW_MANIFEST = "raw/manifest.json"
